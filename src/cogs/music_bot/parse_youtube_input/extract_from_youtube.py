...
class YtdlSource(discord.PCMVolumeTransformer):
    ...
    async def get_from_source(
        ...
        *, 
        ...
        source = discord.FFmpegPCMAudio(video_info.stream_url, **cls.FFMPEG_CONFIG)
        return cls(ctx, source, video_info=video_info, volume=volume)
